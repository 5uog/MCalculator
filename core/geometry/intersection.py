...
def segment_intersects_aabb(p0: Vec3, p1: Vec3, box: AABB, eps: float = 1e-12) -> SegmentHit:
    ...
    if tmax < 0.0 or tmin > 1.0:
        return SegmentHit(False, 0.0, 0.0)
    return SegmentHit(True, max(0.0, tmin), min(1.0, tmax))